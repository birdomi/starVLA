...
# Single-node training. Override from shell if needed:
#   HUMANOIDGEN_DATA=/path/to/HUMANOIDGEN_DATA CUDA_VISIBLE_DEVICES=0,1,2,3 NUM_PROCESSES=4 bash examples/HUMANOIDGEN/train_files/run_humanoidgen_train.sh
...
run_id=${run_id:-humanoidgen_qwengroot_rmse}
